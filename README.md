...
[![Build Status](https://img.shields.io/github/actions/workflow/status/joaquinbejar/IronCondor/ci.yml)](https://github.com/joaquinbejar/IronCondor/actions)
[![Dependencies](https://img.shields.io/librariesio/github/joaquinbejar/IronCondor)](https://libraries.io/github/joaquinbejar/IronCondor)
...
- **Documentation**: <https://docs.rs/ironcondor>
...
| [positive](https://github.com/joaquinbejar/positive) · [crates.io](https://crates.io/crates/positive) | Type-safe wrapper for guaranteed non-negative Decimal values. *(dev-dependency)* |
